lib.callback.register('carse_contrato:getContractOption', function()
...
lib.callback.register('carse_contrato:getTargetPlayer', function()
...
lib.callback.register('carse_contrato:getAgreement', function(price, label, name)
...
lib.callback.register('carse_contrato:societyPrompt', function(type)
    local result = lib.alertDialog({
...
RegisterNetEvent('carse_contrato:contractAnim', function(message)
    lib.progressBar({
        label = message,
